-- =============================================
-- Créer ou mettre à jour la table questionnaire_technique
-- =============================================

-- Supprimer l'ancienne table si elle existe (avec un autre nom)
DROP TABLE IF EXISTS public.questionnaires_techniques CASCADE;

-- Créer la table questionnaire_technique
...
-- Politique : Les utilisateurs peuvent créer leurs propres QT
...
-- Politique : Les utilisateurs peuvent modifier leurs propres QT
...
COMMENT ON TABLE public.questionnaire_technique IS 'Questionnaires techniques par procédure';
COMMENT ON COLUMN public.questionnaire_technique.numero_procedure IS 'Numéro court de la procédure (5 chiffres)';
COMMENT ON COLUMN public.questionnaire_technique.data IS 'Structure JSONB du questionnaire (critères, etc.)';
