...
import type { DataConflict, ConflictResolution } from '../../utils/procedureSyncService';
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="px-6 py-3 bg-green-50 border-b border-green-100">
          <div className="flex items-start gap-2">
            <Database className="w-5 h-5 text-green-700 mt-0.5 flex-shrink-0" />
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center gap-3 p-3 border-2 rounded-lg cursor-pointer transition-all hover:bg-gray-50 has-[:checked]:border-green-500 has-[:checked]:bg-green-50">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-gray-500">
                        La table procédures sera mise à jour avec : <strong className="text-green-700">{conflict.dceValue || 'Vide'}</strong>
                      </div>
                    </div>
        ...
        <div className="px-6 py-3 bg-gray-50 border-t border-gray-200">
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-600">
                <strong className="text-green-700">{dceCount}</strong> depuis DCE
              </span>
              <span className="text-gray-600">
