...
const Dashboard: React.FC<Props> = ({ data, onReset, onBack }) => {
  ...
  const formatNumber = (val: number) => new Intl.NumberFormat('fr-FR', { maximumFractionDigits: 2 }).format(val);
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-3 flex justify-between items-center z-10 shrink-0">
        <div className="flex items-center gap-4">
          {onBack ? (
            <button 
                onClick={onBack}
                className="text-gray-500 hover:text-green-700 transition p-2 rounded-full hover:bg-gray-100 no-print flex items-center gap-1" 
            ...
            <button 
                onClick={onReset}
                className="text-gray-500 hover:text-green-700 transition p-2 rounded-full hover:bg-gray-100 no-print" 
        ...
        <div className="flex gap-3 no-print">
          ...
          {technicalAnalysis && (
              <button 
                ...
                className="flex items-center gap-2 bg-emerald-100 hover:bg-emerald-200 text-emerald-800 px-4 py-2 rounded-lg text-sm font-medium transition shadow border border-emerald-200"
              >
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition shadow disabled:opacity-70 disabled:cursor-wait"
          >
          ...
          <button onClick={handleExportExcel} disabled={isExporting} className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition shadow disabled:opacity-50">
          ...
          <button onClick={handleExportPDF} disabled={isExporting} className="flex items-center gap-2 bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 rounded-lg text-sm font-medium transition shadow disabled:opacity-50">
                  ...
                  <div className="flex items-center justify-between p-4 border-t border-gray-200 bg-gray-50/50 no-print">
                    ...
                    <div className="flex items-center gap-2">
                        <button 
                            ...
                            className="p-1.5 rounded-md hover:bg-gray-200 disabled:opacity-30 disabled:hover:bg-transparent transition text-gray-600"
                        >
