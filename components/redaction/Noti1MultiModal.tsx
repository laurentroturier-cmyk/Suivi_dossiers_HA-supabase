...
interface Noti1MultiModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function Noti1MultiModal({ isOpen, onClose }: Noti1MultiModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-400 to-blue-500 text-white p-6 flex items-center justify-between opacity-70">
          <div className="flex items-center gap-3">
            <Construction className="w-8 h-8" />
            <div>
              <h2 className="text-2xl font-bold">NOTI1 Multi-Attributaires</h2>
        ...
        <div className="p-6 opacity-50">
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 font-semibold">Interface de saisie NOTI1 Multi-Attributaires</p>
